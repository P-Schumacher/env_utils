...
# Register myomimic envs
import myosuite.envs.myo.myomimic # noqa
myosuite_myomimic_suite = set(gym.envs.registration.registry.env_specs.keys())-myosuite_env_suite-_current_gym_envs
myosuite_env_suite  = myosuite_env_suite | myosuite_myomimic_suite
myosuite_myomimic_suite = sorted(myosuite_myomimic_suite)
